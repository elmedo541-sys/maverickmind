...
export default async function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-navy/95 text-white shadow-[0_8px_30px_rgba(11,31,58,0.12)] backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-[1800px] items-center justify-between px-4 py-3 sm:px-6 lg:px-8 xl:px-10">
        <Link href="/" aria-label="Maverick Minds home" className="shrink-0">
          <Logo />
        </Link>
          ...
          <nav className="hidden md:block" aria-label="Main navigation">
            <ul className="flex items-center gap-1 text-sm font-semibold">
              ...
              <li className="ml-1">
                <Link
                  href="/contact"
                  className="inline-flex items-center rounded-lg bg-blue-600 px-4 py-2.5 font-semibold text-white shadow-sm transition hover:bg-blue-500 hover:shadow-md"
                >
                  Contact Us
                </Link>
              </li>
